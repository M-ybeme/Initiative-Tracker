...
// QA needs access to a broader content list for regression flows.
// This includes non-SRD races, subclasses, subraces, etc.
...
// SRD 5.2 (2024) contains NO subclass text or features.
// For the regression pack, we include subclasses so QA can test full character creation flows.
