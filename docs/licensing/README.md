...
- **Creative Commons Attribution 4.0 (SRD 5.1)** applies to any text, stat blocks, or rule mechanics derived from Wizards of the Coast’s SRD release. We must provide attribution wherever that content appears.

## Deliverables for Phase 0
1. ✅ `SRD-5.1-CC-BY-4.0.md` – authoritative copy/paste of the CC BY 4.0 legalcode bundled with the repo.
...
## SRD Reference PDF
- Primary source: https://media.wizards.com/2016/downloads/DND/SRD-OGL_V5.1.pdf
