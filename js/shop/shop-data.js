...
// ---------- Restock Timers (by shop type; settlement adjusts the label) ----------
const RESTOCK_BASE = {
  "Inn/Tavern":              { days:[1,1],  note:"perishables daily, specialty weekly" },
  "Bakery":                  { days:[1,1],  note:"baked fresh daily" },
  "Butcher":                 { days:[1,2],  note:"depends on slaughter schedule" },
  "Grocer":                  { days:[2,4],  note:"market deliveries every few days" },
  "General Goods":           { days:[5,10], note:"depends on supplier run" },
  "Adventuring Gear":        { days:[7,14], note:"specialty orders can take longer" },
  "Blacksmith (Arms/Armor)": { days:[5,10], note:"forged to order; common stock varies" },
  "Cobbler":                 { days:[3,7],  note:"made or sourced in short batches" },
  "Tailor":                  { days:[7,14], note:"fabric in, garments out" },
  "Fabric Shop":             { days:[7,14], note:"bulk deliveries" },
  "Tanner":                  { days:[5,10], note:"depends on hide availability" },
  "Alchemist/Apothecary":    { days:[3,7],  note:"fresh ingredients needed" },
  "Potions & Elixirs":       { days:[5,14], note:"brewing takes time" },
  "Arcane Scrolls":          { days:[14,21],note:"transcription is slow careful work" },
  "Divine Scrolls":          { days:[7,14], note:"blessed materials required" },
  "Magic Items":             { days:[14,30],note:"rare sources, irregular supply" },
  "Bookshop/Library":        { days:[7,21], note:"depends on shipment routes" },
  "Cartographer":            { days:[14,28],note:"surveys and printing take time" },
  "Jeweler":                 { days:[14,21],note:"gem sourcing is unpredictable" },
  "Painter/Sculptor":        { days:[14,28],note:"commissions and supply both slow" },
  "Stables":                 { days:[1,3],  note:"feed daily; tack as needed" },
  "Farrier":                 { days:[3,7],  note:"iron stock replenished regularly" },
  "Carpenter":               { days:[3,7],  note:"lumber delivered in batches" },
  "Wheelwright":             { days:[7,14], note:"oak seasoning takes time" },
  "Messenger":               { days:[1,1],  note:"daily service rotation" },
  "Fortune Teller":          { days:[3,7],  note:"materials as needed" },
  "Black Market":            { days:[2,5],  note:"deliberately unpredictable" },
  "Pawn Shop":               { days:[1,2],  note:"walk-in stock; constantly changing" },
...
// ---------- Shop Buy Affinities (keyword matching for sell-to-shop) ----------
const SHOP_BUYS = {
  "Blacksmith (Arms/Armor)": { kw:["weapon","sword","axe","blade","dagger","spear","shield","armor","mail","helm","plate","gauntlet","greave","mace","hammer","bow","arrow","quiver","warhammer","morningstar","halberd","pike","glaive","scabbard","buckler","knife","lance","rapier","crossbow","bolt","arrowhead","gorget","coif","brigandine","scale","lance","flail","whip","trident","war pick","sickle","club","staff","dart","sling"], aff:0.50, label:"weapons and armor" },
  "General Goods":           { kw:["rope","lantern","lamp","oil","sack","bedroll","waterskin","tool","kit","pot","pan","candle","tin","jar","pouch","hook","bucket","kettle","tarp","canvas","chain","twine","cord","bag","crate","barrel","blanket","cloth","needle","thread","soap","flask","bottle","vial"], aff:0.35, label:"general supplies" },
  "Adventuring Gear":        { kw:["rope","pack","backpack","bedroll","torch","ration","food","kit","tent","trap","manacle","mirror","pole","hook","grapple","spike","piton","shovel","crowbar","tinderbox","whistle","flint","steel","climbing","harness","caltrops","fishing","spyglass","signal","lantern","ball bearing","chain","pulley","tarp","canvas"], aff:0.40, label:"adventuring supplies" },
  "Alchemist/Apothecary":    { kw:["potion","elixir","tincture","salve","powder","herb","mushroom","ingredient","vial","flask","antidote","antitoxin","poison","reagent","alchemical","acid","solution","tonic","extract","root","leaf","bark","resin","oil","compound","kit","sample","chemical","mineral"], aff:0.40, label:"alchemical ingredients and preparations" },
  "Potions & Elixirs":       { kw:["potion","elixir","draught","philter","tonic","vial","flask","healing","resistance","speed","invisibility","climbing","swimming","darkvision","breath","fire","cold","acid","lightning","strength","dexterity","constitution","intelligence","wisdom","charisma","stamina","vigor","cure"], aff:0.45, label:"potions and magical draughts" },
  "Arcane Scrolls":          { kw:["scroll","spell","arcane","magic","enchantment","incantation","glyph","rune","sigil","ward","vellum","parchment","cantrip","ritual","formula","inscription","text","formula"], aff:0.50, label:"arcane scrolls and spells" },
  "Divine Scrolls":          { kw:["scroll","holy","divine","sacred","blessing","prayer","ritual","vellum","parchment","religious","consecrated","ward","healing","restoration","cure","clerical","scripture","hymn"], aff:0.50, label:"divine scrolls and holy writings" },
  "Magic Items":             { kw:["magic","enchanted","magical","artifact","charm","amulet","ring","wand","staff","rod","orb","crystal","rune","cursed","blessed","attuned","power","glow","radiant","enchantment","arcane","mystic"], aff:0.45, label:"magical and enchanted items" },
  "Bookshop/Library":        { kw:["book","tome","scroll","journal","diary","letter","manuscript","vellum","parchment","map","atlas","almanac","bestiary","treatise","guide","primer","codex","text","record","ledger","document","inscription","folio","pamphlet"], aff:0.40, label:"books and documents" },
  "Jeweler":                 { kw:["gem","jewel","ring","necklace","bracelet","earring","pendant","brooch","tiara","circlet","crown","locket","chain","gold","silver","platinum","sapphire","ruby","emerald","diamond","pearl","gemstone","opal","crystal","jewelry","precious","stone","metal"], aff:0.55, label:"gems and jewelry" },
  "Pawn Shop":               { kw:[], aff:0.25, label:"nearly anything" },
  "Black Market":            { kw:["stolen","illicit","contraband","weapon","potion","magic","gem","jewelry","document","forgery","lockpick","poison","acid","smoke","smuggled","unusual","valuable","rare","restricted","forbidden"], aff:0.30, label:"unusual and hard-to-source goods" },
  "Tailor":                  { kw:["cloth","fabric","clothing","garment","cloak","robe","tunic","shirt","trousers","dress","cape","wool","silk","linen","cotton","leather","hide","fur","thread","needle","dye","button","clasp","belt","curtain","tapestry"], aff:0.40, label:"clothing and fabric" },
  "Cobbler":                 { kw:["boot","shoe","sandal","footwear","sole","leather","hide","buckle","strap","spur","heel","moccasin","slipper","clog"], aff:0.40, label:"footwear and leather goods" },
  "Tanner":                  { kw:["hide","leather","pelt","fur","skin","rawhide","suede","strip","cord","thong","vellum","gut","sinew","cured"], aff:0.50, label:"hides and leather" },
  "Stables":                 { kw:["saddle","harness","bridle","bit","rein","stirrup","horseshoe","tack","feed","hay","oat","grain","mount","horse","mule","donkey","pony","riding","cart","wagon","blanket","grooming","brush"], aff:0.40, label:"tack, feed, and riding equipment" },
  "Grocer":                  { kw:["food","grain","flour","rice","oat","bean","spice","herb","vegetable","fruit","salt","sugar","honey","oil","vinegar","tea","coffee","ration","provision","ingredient","preserve","pickled","dried","smoked","cheese","butter","nuts","seeds"], aff:0.40, label:"food and provisions" },
  "Carpenter":               { kw:["wood","plank","lumber","beam","board","crate","box","chest","furniture","door","frame","table","chair","shelf","barrel","bucket","tool","saw","chisel","nail","screw","peg","hinge","latch"], aff:0.40, label:"wood goods and furniture" },
  "Cartographer":            { kw:["map","chart","atlas","compass","survey","vellum","parchment","route","road","region","territory","navigation","geography","gazetteer"], aff:0.50, label:"maps and navigation tools" },
  "Painter/Sculptor":        { kw:["art","painting","sculpture","pigment","paint","brush","canvas","chisel","clay","stone","carving","portrait","drawing","ink","sketch","illustration","dye","color","palette"], aff:0.40, label:"art and art supplies" },
  "Fortune Teller":          { kw:["charm","amulet","talisman","crystal","orb","card","reading","divination","omen","rune","token","fetish","totem","ritual","bone","feather","bead","trinket"], aff:0.35, label:"charms and divination items" },
  "Clockwork Repair":        { kw:["clock","gear","spring","mechanism","watch","timepiece","clockwork","wind","crank","key","automaton","device","contraption","metal","brass","copper","tin","iron","cog","wheel"], aff:0.50, label:"clockwork mechanisms and parts" },
  "Pet Shop":                { kw:["animal","bird","cat","dog","rat","snake","lizard","creature","beast","pet","companion","cage","feed","leash","collar","fish","insect","spider","ferret","rabbit"], aff:0.40, label:"animals and animal care" }
};
