...
**Live Site:** [https://dnddmtoolbox.netlify.app/](https://dnddmtoolbox.netlify.app/) · **Version:** 2.3.17
...
* **Spell list grouped by level** – Known spells are organized under Cantrip, 1st Level, … 9th Level section headers for fast lookup at the table
* **Ritual casting** – Ritual-flagged spells show a cyan Ritual badge and a dedicated Ritual button that casts without spending a slot (casting time +10 minutes); works for SRD spells and custom homebrew entries
